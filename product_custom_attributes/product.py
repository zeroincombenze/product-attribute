...
class product_product(Model):
    ...
    _columns = {
        'attribute_group_ids': fields.function(_attr_grp_ids,
                                               type='many2many',
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form',
        ...
        if view_type == 'form' and context.get('attribute_group_ids'):
            ...
            attributes_notebook, toupdate_fields = self.pool.get(
                'attribute.attribute')._build_attributes_notebook(
                    cr, uid, context['attribute_group_ids'], context=context)
            result['fields'].update(self.fields_get(
                cr, uid, toupdate_fields, context))
